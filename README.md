...
| :---: | --- | --- |
| **L1** | Software test, no hardware attached | 101 unit tests; reference sim closes to 0.0022 rad |
...
python -m unittest discover -s tests              # 101 tests
...
# wall-trowel simulation chain (scene, EE control, task, demos, error model) — see docs/SIMULATION.md
...
tests/           101 tests; hardware-dependent ones skip cleanly
