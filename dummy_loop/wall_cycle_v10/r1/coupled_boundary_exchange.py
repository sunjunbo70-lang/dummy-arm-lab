"""Candidate finite-blade / moving-wall exchange. No pressure or lift physics.
...
VERSION='v10r1.coupled_boundary_exchange.midpoint.v1'

def exchange(wall,blade,area0,area1,blade_area,entry,exit,gap,max_iter=80,tol=1e-18):
 ...
 for iteration in range(max_iter):
  ...
  deposited=np.bincount(ow,weights=oa*density[ob],minlength=nw)
 ...
 return remaining,final_blade,lost,dict(iterations=iterations,residual_m3=residual)
