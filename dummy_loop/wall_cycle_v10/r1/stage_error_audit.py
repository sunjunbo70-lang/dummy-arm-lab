"""Paired-stage localization of coupled candidate integration errors."""
...
def main():
    ...
    for seed in range(6):
        ...
        for n in [201,401]:
            ...
            before=s.wall.copy()/s.wc**2;s.lift(.75);after=s.wall/s.wc**2
            pair.append((snapshots,before,after,after-before,time.perf_counter()-start))
        ...
        report.append(row);np.savez_compressed(out/f'case_{seed:02d}.npz',**stored)
