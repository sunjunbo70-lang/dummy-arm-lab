"""Expanded v8.2 bounded-edge material audit. No robot, transport pose or observation gate claim."""
...
def run_case(job):
    ...
    models=[BoundedEdgePressure(base.wall*base.wall_cell_area,base.blade*base.blade_cell_area,params=copy.deepcopy(base.p)) for _ in range(2)]
