...
def main():
 ...
 jobs=[external('RL1',11,BASE/'RL1_seed11_stage100_008'),external('RL2',11,BASE/'RL2_seed11_stage100_001')]
 jobs += [job(g,s,100,out) for g in ['RL1','RL2'] for s in [22,33]]
 jobs += [job(g,11,100,out) for g in ['RL0','Scratch','straight','no_edge','old_stop']]
