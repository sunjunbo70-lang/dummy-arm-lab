"""Straight-only recovery DAgger; same labels and budget, straight execution environment."""
...
def main():
 ...
 for ep in range(a.episodes):
  e=(A0Env if state.get('action_space')=='A0' else Env)(a.seed+ep,reach,task=TASKS[ep%6],straight=True);X=[];OP=[];P=[];M=[];initial=e.initial_wall.copy()
  while not e.done:
