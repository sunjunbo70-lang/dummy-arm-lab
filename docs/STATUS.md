...
| 整片连续强化学习 v0.2 | 材料守恒、D435 代理观测、连续空间动作与完整回位/装料/重扫闭环；PPO 100 组平均覆盖 0.924、RMSE 0.382 mm；自由视角回放可用 | ../experiments/2026-09-22_wall_cycle_rl/，docs/WALL_CYCLE_RL.md | L1 |
