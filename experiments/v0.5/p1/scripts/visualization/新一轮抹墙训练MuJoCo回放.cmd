...
set "POLICY=experiments\v0.5\p1\records\2026-09-22_wall_cycle_v05\raw\p1_training\policy.npz"
set "REPLAY=experiments\v0.5\p1\records\2026-09-22_wall_cycle_v05\raw\native_replay_seed_20005_bare\rollout.npz"
if exist "%REPLAY%" (
  ...
  ".venv-loop\Scripts\python.exe" -m dummy_loop.wall_cycle.view --v05 --mixed-initial --policy "%POLICY%" --seed 20005 --out "experiments\v0.5\p1\runs\v05_p1_seed20005"
) else (
